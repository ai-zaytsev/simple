...
Если изменение выкатывается, есть ещё один шаг после мерджа: сверка панели с ожиданием. Стадия не закрывается, пока живые числа не прочитаны и результат сверки не назван. Подробности и причина — в `CLAUDE.md`, раздел Definition Of Done.

Открытый долг закрытию стадии не мешает — незаписанный мешает. Всё, что не выяснено за проход, идёт в `docs/tech-debt.md` с указанием риска и условия закрытия.
