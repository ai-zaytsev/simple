# Tasks: Мобильная версия сайта и установка APK

- [x] Проверить актуальные официальные инструкции Android и Samsung
- [x] Реализовать единый responsive install flow
- [x] Сохранить `/releases.json` единственным источником latest/history
...
- [x] После первой официальной APK пройти установку на реальном Android — 2026-09-01, путь сайт → скачивание → установка → вход пройден, инструкция совпала
