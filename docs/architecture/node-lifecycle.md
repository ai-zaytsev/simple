...
| --- | --- | --- |
| `free` | FREE-аккаунты | Расходуемый; разведка через бесплатные аккаунты не раскрывает платные мощности |
| `vip` | VIP-аккаунты | Защищаемый; выдача только платным аккаунтам повышает цену разведки |
...
- нода в пуле, соответствующем entitlement аккаунта
