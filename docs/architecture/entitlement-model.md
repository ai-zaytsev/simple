...
| Нода | Принимает только переданный Core `vpn_credential_id`; применяет шейпинг скорости | Отзыв после ближайшей полной синхронизации без ожидания Android refresh |
