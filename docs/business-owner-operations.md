...
| Официальный сайт | Работает через Cloudflare: `/` = 200, `/healthz` = 204; live deploy `33506736236`: `No changes`, `0 added / 0 changed / 0 destroyed`, responsive Android/Samsung guide опубликован, HTML перепроверяется браузером | `site-1` и CI-доступ восстановлены без создания или замены Droplet; firewall после deploy снова web-only; первый официальный APK ещё не опубликован |
