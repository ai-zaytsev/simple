...
| Домен ноды заблокирован | Device checks плохие, Core checks хорошие | Сначала направить свободный расходный домен на ту же ноду и посмотреть device checks: ожили — блокировали имя, машина цела. Не ожили — создать ноду с новым IP/доменом, затем вывести старую |
