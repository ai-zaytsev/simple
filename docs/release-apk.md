...
Пользовательская инструкция установки живёт только на главной странице
официального домена: краткие шаги видны сразу, Android/Samsung details
раскрываются там же. Технические и BO-документы ссылаются на сайт и не копируют
пользовательский текст, чтобы названия меню исправлялись один раз.
